...
i18n.input.chrome.inputview.Css = {A11Y:"inputview-a11y", ALTDATA_COVER:"inputview-altdata-cover", ALTDATA_KEY:"inputview-altdata-key", ALTDATA_SEPARATOR:"inputview-altdata-separator", ALTDATA_VIEW:"inputview-altdata-view", ALTGR_CONTENT:"inputview-ac", ARROW_KEY:"inputview-arrow-key", BACKSPACE_ICON:"inputview-backspace-icon", CANDIDATE:"inputview-candidate", CANDIDATES_LINE:"inputview-candidates-line", CANDIDATES_TOP_LINE:"inputview-candidates-top-line", CANDIDATE_BUTTON:"inputview-candidate-button", 
CANDIDATE_DEFAULT:"inputview-candidate-default", CANDIDATE_HIGHLIGHT:"inputview-candidate-highlight", CANDIDATE_INTER_CONTAINER:"inputview-candiate-ic", CANDIDATE_SEPARATOR:"inputview-candidate-separator", CANDIDATE_VIEW:"inputview-candidate-view", CANVAS:"inputview-canvas", CANVAS_LEFT_COLUMN:"inputview-canvas-left-column", CANVAS_RIGHT_COLUMN:"inputview-canvas-right-column", CANVAS_VIEW:"inputview-canvasview", CAPSLOCK_DOT:"inputview-capslock-dot", CAPSLOCK_DOT_HIGHLIGHT:"inputview-capslock-dot-highlight", 
CHARACTER:"inputview-character", CHARACTER_HIGHLIGHT:"inputview-ch", COMPACT_KEY:"inputview-compact-key", COMPACT_SWITCHER:"inputview-compact-switcher", CONTAINER:"inputview-container", DEFAULT_CONTENT:"inputview-dc", DIGIT_CHARACTER:"inputview-digit-character", DOWN_KEY:"inputview-down-key", ELEMENT_HIGHLIGHT:"inputview-element-highlight", ENTER_ICON:"inputview-enter-icon", EXPAND_CANDIDATES_ICON:"inputview-expand-candidates-icon", FONT:"inputview-font", GLOBE_ICON:"inputview-globe-icon", HANDWRITING:"inputview-handwriting", 
HANDWRITING_BACK:"inputview-handwriting-back", HANDWRITING_LAYOUT:"inputview-handwriting-layout", HANDWRITING_NETWORK_ERROR:"inputview-handwriting-network-error", HANDWRITING_SWITCHER:"inputview-handwriting-switcher", HANDWRITING_PRIVACY_INFO:"inputview-handwriting-privacy-info", HANDWRITING_PRIVACY_INFO_HIDDEN:"inputview-handwriting-privacy-info-hidden", HIDE_KEYBOARD_ICON:"inputview-hide-keyboard-icon", HINT_TEXT:"inputview-hint-text", HOLD:"inputview-hold", IME_LIST_CONTAINER:"inputview-ime-list-container", 
INLINE_DIV:"inputview-inline-div", JP_IME_SWITCH:"inputview-jp-ime-switch", KEY_HOLD:"inputview-key-hold", LAYOUT_VIEW:"inputview-layoutview", LEFT_KEY:"inputview-left-key", LINEAR_LAYOUT:"inputview-linear", MENU_FOOTER:"inputview-menu-footer", MENU_FOOTER_HANDWRITING_BUTTON:"inputview-menu-footer-handwriting-button", MENU_FOOTER_ITEM:"inputview-menu-footer-item", MENU_FOOTER_SETTING_BUTTON:"inputview-menu-footer-setting-button", MENU_LIST_INDICATOR:"inputview-menu-list-indicator", MENU_LIST_INDICATOR_NAME:"inputview-menu-list-indicator-name", 
MENU_LIST_ITEM:"inputview-menu-list-item", MENU_LIST_NAME:"inputview-menu-list-name", MENU_VIEW:"inputview-menu-view", MODIFIER:"inputview-modifier", MODIFIER_ON:"inputview-modifier-on", MODIFIER_STATE_ICON:"inputview-modifier-state-icon", PAGE_DOWN_ICON:"inputview-page-down-icon", PAGE_UP_ICON:"inputview-page-up-icon", REGULAR_SWITCHER:"inputview-regular-switcher", RIGHT_KEY:"inputview-right-key", SHIFT_ICON:"inputview-shift-icon", SHRINK_CANDIDATES_ICON:"inputview-shrink-candidates-icon", SOFT_KEY:"inputview-sk", 
SOFT_KEY_VIEW:"inputview-skv", SPACE_ICON:"inputview-space-icon", SPECIAL_KEY_BG:"inputview-special-key-bg", SPECIAL_KEY_HIGHLIGHT:"inputview-special-key-highlight", SPECIAL_KEY_NAME:"inputview-special-key-name", TABLE_CELL:"inputview-table-cell", TAB_ICON:"inputview-tab-icon", THREE_CANDIDATES:"inputview-three-candidates", TITLE:"inputview-title", TITLE_BAR:"inputview-title-bar", UP_KEY:"inputview-up-key", VERTICAL_LAYOUT:"inputview-vertical", VIEW:"inputview-view", WRAPPER:"inputview-wrapper"};
...
SHRINK_CANDIDATES:29, EXPAND_CANDIDATES:30, CANDIDATES_PAGE_UP:31, CANDIDATES_PAGE_DOWN:32, CANDIDATE:33, EXPANDED_CANDIDATE_VIEW:34, IME_SWITCH:35, HWT_PRIVACY_GOT_IT:36, MENU_ITEM:37};
...
i18n.input.chrome.inputview.elements.content.CandidateButton.prototype.createDom = function $i18n$input$chrome$inputview$elements$content$CandidateButton$$createDom$() {
  ...
  this.tableCell = dom.createDom(goog.dom.TagName.DIV, i18n.input.chrome.inputview.Css.TABLE_CELL);
...
i18n.input.chrome.inputview.elements.content.CandidateView.prototype.createSeparator_ = function $i18n$input$chrome$inputview$elements$content$CandidateView$$createSeparator_$() {
...
i18n.input.chrome.inputview.elements.content.SoftKey.GAUSSIAN_COVARIANCE_ = 120;
...
i18n.input.chrome.inputview.elements.content.SoftKey.prototype.resize = function $i18n$input$chrome$inputview$elements$content$SoftKey$$resize$(width, height) {
  ...
  this.estimator = new i18n.input.chrome.inputview.elements.content.GaussianEstimator(this.centerCoordinate, i18n.input.chrome.inputview.elements.content.SoftKey.GAUSSIAN_COVARIANCE_, this.availableHeight / this.availableWidth);
};
...
i18n.input.chrome.inputview.elements.content.MenuView.Command = {SWITCH_IME:0, SWITCH_KEYSET:1, OPEN_HANDWRITING:2, OPEN_SETTING:3};
...
i18n.input.chrome.inputview.elements.content.MenuView.prototype.show = function $i18n$input$chrome$inputview$elements$content$MenuView$$show$(key, currentKeysetId, isCompact, enableCompactLayout, inputMethods, hasHwt, enableSettings) {
  ...
  if (key.type != ElementType.MENU_KEY) {
    ...
    var totalHeight = 0, totalHeight = totalHeight + this.addInputMethodItems_(inputMethods), totalHeight = totalHeight + this.addLayoutSwitcherItem_(key, currentKeysetId, isCompact, enableCompactLayout);
...
i18n.input.chrome.inputview.elements.content.MenuView.prototype.addInputMethodItems_ = function $i18n$input$chrome$inputview$elements$content$MenuView$$addInputMethodItems_$(inputMethods) {
...
i18n.input.chrome.inputview.elements.content.MenuView.prototype.addLayoutSwitcherItem_ = function $i18n$input$chrome$inputview$elements$content$MenuView$$addLayoutSwitcherItem_$(key, currentKeysetId, isCompact, enableCompactLayout) {
  ...
  this.getDomHelper();
  var layoutSwitcher = {};
  isCompact ? (layoutSwitcher.iconURL = "images/regular_size.png", layoutSwitcher.name = "Switch to full layout", currentKeysetId.split(".")) : (layoutSwitcher.iconURL = "images/compact.png", layoutSwitcher.name = "Switch to compact layout");
  layoutSwitcher.command = [i18n.input.chrome.inputview.elements.content.MenuView.Command.SWITCH_KEYSET, key.toKeyset];
...
i18n.input.chrome.inputview.elements.content.MenuView.prototype.addFooterItems_ = function $i18n$input$chrome$inputview$elements$content$MenuView$$addFooterItems_$(hasHwt) {
...
i18n.input.chrome.inputview.events.KeyClickEvent = {};
i18n.input.chrome.inputview.events.EventType = {CONFIG_LOADED:"cl$0", DOUBLE_CLICK:"dc$1", LAYOUT_LOADED:"ll$2", LONG_PRESS:"lp$3", LONG_PRESS_END:"lpe$4", POINTER_DOWN:"pd$5", POINTER_UP:"pu$6", POINTER_OVER:"po$7", POINTER_OUT:"po$8", SETTINGS_READY:"sr$9", SURROUNDING_TEXT_CHANGED:"stc$10", SWIPE:"s$11", CONTEXT_UPDATE:"cu$12", CONTEXT_FOCUS:"cf$13", CONTEXT_BLUR:"cb$14", VISIBILITY_CHANGE:"vc$15", MODEL_UPDATE:"mu$16"};
...
i18n.input.chrome.inputview.events.ContextFocusEvent = function $i18n$input$chrome$inputview$events$ContextFocusEvent$(contextType) {
  goog.events.Event.call(this, i18n.input.chrome.inputview.events.EventType.CONTEXT_FOCUS);
  this.contextType = contextType;
};
goog.inherits(i18n.input.chrome.inputview.events.ContextFocusEvent, goog.events.Event);
...
i18n.input.chrome.inputview.handler.PointerActionBundle.prototype.handlePointerUp = function $i18n$input$chrome$inputview$handler$PointerActionBundle$$handlePointerUp$(e) {
  ...
  if (!(this.isDBLClicking_ || this.isLongPressing_ && this.view_.pointerConfig.longPressWithoutPointerUp)) {
    ...
    if (!view || this.isFlickering_) {
      view = this.view_, target = e.target;
    }
    view && this.dispatchEvent(new i18n.input.chrome.inputview.events.PointerEvent(view, i18n.input.chrome.inputview.events.EventType.POINTER_UP, target, pageOffset.x, pageOffset.y));
  }
...
i18n.input.chrome.inputview.handler.PointerActionBundle.prototype.handlePointerDown = function $i18n$input$chrome$inputview$handler$PointerActionBundle$$handlePointerDown$(e) {
  ...
  if (!this.isDBLClicking_) {
    var pageOffset = this.getPageOffset_(e);
    this.dispatchEvent(new i18n.input.chrome.inputview.events.PointerEvent(this.view_, i18n.input.chrome.inputview.events.EventType.POINTER_DOWN, e.target, pageOffset.x, pageOffset.y));
  }
  e.preventDefault();
  e.stopPropagation();
};
...
i18n.input.chrome.inputview.handler.PointerActionBundle.prototype.maybeHandleDBLClick_ = function $i18n$input$chrome$inputview$handler$PointerActionBundle$$maybeHandleDBLClick_$(e) {
  if (this.view_ && this.view_.pointerConfig.dblClick) {
    var timeInMs = (new Date).getTime(), interval = i18n.input.chrome.inputview.handler.PointerActionBundle.DOUBLE_CLICK_INTERVAL_, nativeEvt = e.getBrowserEvent();
...
i18n.input.chrome.inputview.handler.PointerHandler = function $i18n$input$chrome$inputview$handler$PointerHandler$() {
  goog.events.EventTarget.call(this);
...
i18n.input.chrome.inputview.handler.PointerHandler.prototype.createPointerHandler_ = function $i18n$input$chrome$inputview$handler$PointerHandler$$createPointerHandler_$(target) {
...
i18n.input.chrome.inputview.handler.PointerHandler.prototype.onPointerUp_ = function $i18n$input$chrome$inputview$handler$PointerHandler$$onPointerUp_$(e) {
  if (!this.isOnCanvas_(e)) {
    var uid = goog.getUid(e.target), pointerHandler = this.pointerActionBundles_[uid];
  ...
  if (!this.isOnCanvas_(e)) {
    ...
    if (touches && 0 != touches.length) {
      for (var i = 0;i < touches.length;i++) {
        var uid = goog.getUid(touches[i].target), pointerHandler = this.pointerActionBundles_[uid];
...
i18n.input.chrome.inputview.handler.PointerHandler.prototype.isOnCanvas_ = function $i18n$input$chrome$inputview$handler$PointerHandler$$isOnCanvas_$(e) {
  return e.target.className == i18n.input.chrome.inputview.handler.PointerHandler.CANVAS_CLASS_NAME_;
};
...
i18n.input.chrome.DataSource.EventType = {CANDIDATES_BACK:"cb$17", READY:"r$18"};
i18n.input.chrome.DataSource.CandidatesBackEvent = function $i18n$input$chrome$DataSource$CandidatesBackEvent$(source, candidates, opt_matchedLengths) {
...
i18n.input.chrome.inputview.Adapter = function $i18n$input$chrome$inputview$Adapter$() {
  goog.events.EventTarget.call(this);
...
i18n.input.chrome.inputview.Adapter.prototype.sendKeyEvent_ = function $i18n$input$chrome$inputview$Adapter$$sendKeyEvent_$(keyData) {
  chrome.runtime.sendMessage(goog.object.create(i18n.input.chrome.message.Name.MSG_TYPE, i18n.input.chrome.message.Type.SEND_KEY_EVENT, i18n.input.chrome.message.Name.KEY_DATA, keyData));
};
...
i18n.input.chrome.inputview.Adapter.prototype.sendHwtRequest = function $i18n$input$chrome$inputview$Adapter$$sendHwtRequest$(payload) {
  chrome.runtime.sendMessage(goog.object.create(i18n.input.chrome.message.Name.MSG_TYPE, i18n.input.chrome.message.Type.HWT_REQUEST, i18n.input.chrome.message.Name.MSG, payload));
};
...
i18n.input.chrome.inputview.Adapter.prototype.onContextFocus_ = function $i18n$input$chrome$inputview$Adapter$$onContextFocus_$(contextType) {
  this.contextType = contextType;
  this.dispatchEvent(new i18n.input.chrome.inputview.events.ContextFocusEvent(this.contextType));
};
i18n.input.chrome.inputview.Adapter.prototype.initialize = function $i18n$input$chrome$inputview$Adapter$$initialize$() {
  ...
  chrome.runtime.sendMessage(goog.object.create(i18n.input.chrome.message.Name.MSG_TYPE, i18n.input.chrome.message.Type.CONNECT));
  chrome.runtime.sendMessage(goog.object.create(i18n.input.chrome.message.Name.MSG_TYPE, i18n.input.chrome.message.Type.VISIBILITY_CHANGE, i18n.input.chrome.message.Name.VISIBILITY, !document.webkitHidden));
  window.inputview && (inputview.getKeyboardConfig && inputview.getKeyboardConfig(function(config) {
    this.isA11yMode = !!config.a11ymode;
  }.bind(this)), inputview.getInputMethods && inputview.getInputMethods(function(inputMethods) {
    this.showGlobeKey = 0 < inputMethods.length;
  }.bind(this)));
...
i18n.input.chrome.inputview.Adapter.prototype.getInputMethods = function $i18n$input$chrome$inputview$Adapter$$getInputMethods$(callback) {
  window.inputview && inputview.getInputMethods ? inputview.getInputMethods(callback) : callback([]);
};
...
i18n.input.chrome.inputview.Adapter.prototype.selectCandidate = function $i18n$input$chrome$inputview$Adapter$$selectCandidate$(candidate) {
  chrome.runtime.sendMessage(goog.object.create(i18n.input.chrome.message.Name.MSG_TYPE, i18n.input.chrome.message.Type.SELECT_CANDIDATE, i18n.input.chrome.message.Name.CANDIDATE, candidate));
};
i18n.input.chrome.inputview.Adapter.prototype.commitText = function $i18n$input$chrome$inputview$Adapter$$commitText$(text) {
  chrome.runtime.sendMessage(goog.object.create(i18n.input.chrome.message.Name.MSG_TYPE, i18n.input.chrome.message.Type.COMMIT_TEXT, i18n.input.chrome.message.Name.TEXT, text));
};
i18n.input.chrome.inputview.Adapter.prototype.setLanguage = function $i18n$input$chrome$inputview$Adapter$$setLanguage$(language) {
  chrome.runtime.sendMessage(goog.object.create(i18n.input.chrome.message.Name.MSG_TYPE, i18n.input.chrome.message.Type.SET_LANGUAGE, i18n.input.chrome.message.Name.LANGUAGE, language));
};
i18n.input.chrome.inputview.Adapter.prototype.onCandidatesBack_ = function $i18n$input$chrome$inputview$Adapter$$onCandidatesBack_$(message) {
  var source = message.source || "", candidates = message.candidates || [], matchedLengths = message.matchedLengths || [];
  this.dispatchEvent(new i18n.input.chrome.DataSource.CandidatesBackEvent(source, candidates, matchedLengths));
};
...
i18n.input.chrome.inputview.Adapter.prototype.setInputToolCode = function $i18n$input$chrome$inputview$Adapter$$setInputToolCode$(inputToolCode) {
  chrome.runtime.sendMessage(goog.object.create(i18n.input.chrome.message.Name.MSG_TYPE, i18n.input.chrome.message.Type.HWT_SET_INPUTTOOL, i18n.input.chrome.message.Name.MSG, inputToolCode));
};
i18n.input.chrome.inputview.Adapter.prototype.unsetInputToolCode = function $i18n$input$chrome$inputview$Adapter$$unsetInputToolCode$() {
  chrome.runtime.sendMessage(goog.object.create(i18n.input.chrome.message.Name.MSG_TYPE, i18n.input.chrome.message.Type.HWT_UNSET_INPUTTOOL));
};
i18n.input.chrome.inputview.Adapter.prototype.onMessage_ = function $i18n$input$chrome$inputview$Adapter$$onMessage_$(request) {
  var type = request[i18n.input.chrome.message.Name.MSG_TYPE], msg = request[i18n.input.chrome.message.Name.MSG];
  switch(type) {
...
i18n.input.chrome.inputview.Adapter.prototype.sendHwtPrivacyConfirmMessage = function $i18n$input$chrome$inputview$Adapter$$sendHwtPrivacyConfirmMessage$() {
  chrome.runtime.sendMessage(goog.object.create(i18n.input.chrome.message.Name.MSG_TYPE, i18n.input.chrome.message.Type.HWT_PRIVACY_GOT_IT));
...
i18n.input.chrome.inputview.CandidatesInfo = function $i18n$input$chrome$inputview$CandidatesInfo$(source, candidates, opt_matchedLengths) {
  this.source = source;
  this.candidates = candidates;
  this.matchedLengths = opt_matchedLengths || null;
};
...
i18n.input.chrome.inputview.ConditionName = {SHOW_COMPACT_LAYOUT_SWITCHER:"showCompactLayoutSwitcher", SHOW_ALTGR:"showAltGr", SHOW_HANDWRITING_SWITCHER:"showHandwritingSwitcher", SHOW_MENU:"showMenu", SHOW_GLOBE_OR_SYMBOL:"showGlobeOrSymbol"};
...
i18n.input.chrome.inputview.elements.content.AltDataView.prototype.highlightIndex_ = 0;
...
i18n.input.chrome.inputview.elements.content.AltDataView.prototype.show = function $i18n$input$chrome$inputview$elements$content$AltDataView$$show$(key, isRTL) {
  this.triggeredBy = key;
  var coordinate = goog.style.getClientPosition(key.getElement()), x = coordinate.x, y = coordinate.y, width = key.availableWidth, height = key.availableHeight, ElementType = i18n.input.chrome.inputview.elements.ElementType, characters;
  if (key.type == ElementType.CHARACTER_KEY) {
    ...
    if (key.type == ElementType.COMPACT_KEY) {
      ...
      characters = [];
      if (0 != accents.length && (characters = goog.array.clone(accents), key.getActiveCharacter().toLowerCase() != key.getActiveCharacter())) {
  ...
  if (characters && 0 != characters.length) {
    ...
    var elemTop = y - height - i18n.input.chrome.inputview.elements.content.AltDataView.PADDING_;
    0 > elemTop && (elemTop = y + height + i18n.input.chrome.inputview.elements.content.AltDataView.PADDING_);
    goog.style.setPosition(this.getElement(), left, elemTop);
    goog.style.setElementShown(this.coverElement_, !0);
    this.triggeredBy.setHighlighted(!0);
  }
...
i18n.input.hwt.EventType = {BACKSPACE:"b$19", CANDIDATE_SELECT:"cs$20", COMMIT:"c$21", COMMIT_START:"hcs$22", COMMIT_END:"hce$23", RECOGNITION_READY:"rr$24", ENTER:"e$25", HANDWRITING_CLOSED:"hc$26", MOUSEUP:"m$27", SPACE:"s$28"};
...
i18n.input.hwt.StrokeHandler.EventType = {STROKE:"s$29", STROKE_END:"se$30", STROKE_START:"ss$31"};
...
i18n.input.chrome.inputview.elements.content.CanvasView.prototype.networkErrorDiv_ = null;
i18n.input.chrome.inputview.elements.content.CanvasView.prototype.privacyDiv_ = null;
i18n.input.chrome.inputview.elements.content.CanvasView.prototype.confirmBtn_ = null;
...
i18n.input.chrome.inputview.elements.content.CanvasView.prototype.resize = function $i18n$input$chrome$inputview$elements$content$CanvasView$$resize$(width, height) {
  ...
  this.networkErrorDiv_.style.left = this.privacyDiv_.style.left = Math.round(width / 2 - 150) + "px";
...
i18n.input.chrome.inputview.elements.content.CharacterModel = function $i18n$input$chrome$inputview$elements$content$CharacterModel$(character, belongToLetterKey, hasAltGrCharacterInTheKeyset, alwaysRenderAltGrCharacter, stateType, stateManager) {
...
i18n.input.chrome.inputview.elements.content.CharacterKey.prototype.createDom = function $i18n$input$chrome$inputview$elements$content$CharacterKey$$createDom$() {
  ...
  for (var i = 0;i < this.characters.length;i++) {
    ...
    if (ch && "\x00" != ch) {
      var model = new i18n.input.chrome.inputview.elements.content.CharacterModel(ch, this.isLetterKey, this.hasAltGrCharacterInTheKeyset_, this.alwaysRenderAltGrCharacter_, i18n.input.chrome.inputview.elements.content.CharacterKey.STATE_LIST_[i], this.stateManager_), character = new i18n.input.chrome.inputview.elements.content.Character(this.id + "-" + i, model, this.isRTL_);
...
i18n.input.chrome.inputview.elements.content.CompactKey = function $i18n$input$chrome$inputview$elements$content$CompactKey$(id, text, hintText, stateManager, opt_marginLeftPercent, opt_marginRightPercent, opt_isGrey, opt_moreKeys, opt_eventTarget) {
  i18n.input.chrome.inputview.elements.content.FunctionalKey.call(this, id, i18n.input.chrome.inputview.elements.ElementType.COMPACT_KEY, text, "", opt_eventTarget);
...
i18n.input.chrome.inputview.elements.content.CompactKey.prototype.createDom = function $i18n$input$chrome$inputview$elements$content$CompactKey$$createDom$() {
  ...
  this.isGrey_ || goog.dom.classlist.remove(this.bgElem, i18n.input.chrome.inputview.Css.SPECIAL_KEY_BG);
  if (this.hintText) {
    var dom = this.getDomHelper();
    dom.removeChildren(this.tableCell);
    var inlineWrap = dom.createDom(goog.dom.TagName.DIV, i18n.input.chrome.inputview.Css.INLINE_DIV);
...
i18n.input.chrome.inputview.elements.content.CompactKey.prototype.resize = function $i18n$input$chrome$inputview$elements$content$CompactKey$$resize$(width, height) {
  ...
  var marginRight = Math.floor(width * this.marginRightPercent_), marginRight = marginRight + 10;
...
i18n.input.chrome.inputview.elements.content.CompactKey.prototype.getActiveCharacter = function $i18n$input$chrome$inputview$elements$content$CompactKey$$getActiveCharacter$() {
  return this.flickerredCharacter ? this.flickerredCharacter : this.stateManager_.hasState(i18n.input.chrome.inputview.StateType.SHIFT) ? this.text.toUpperCase() : this.text;
};
...
i18n.input.chrome.inputview.elements.content.ModifierKey.prototype.update = function $i18n$input$chrome$inputview$elements$content$ModifierKey$$update$() {
  ...
  this.dotIcon_ && (isStateEnabled && isSticky ? goog.dom.classlist.add(this.dotIcon_, i18n.input.chrome.inputview.Css.CAPSLOCK_DOT_HIGHLIGHT) : goog.dom.classlist.remove(this.dotIcon_, i18n.input.chrome.inputview.Css.CAPSLOCK_DOT_HIGHLIGHT));
};
...
i18n.input.chrome.inputview.elements.content.SpaceKey.prototype.setTitleVisible = function $i18n$input$chrome$inputview$elements$content$SpaceKey$$setTitleVisible$(visible) {
  this.textElem && (goog.dom.setTextContent(this.textElem, visible ? this.text : ""), goog.dom.classlist.add(this.textElem, i18n.input.chrome.inputview.Css.TITLE));
};
...
i18n.input.chrome.inputview.elements.layout.LinearLayout = function $i18n$input$chrome$inputview$elements$layout$LinearLayout$(id, opt_eventTarget) {
...
i18n.input.chrome.inputview.elements.layout.LinearLayout.prototype.createDom = function $i18n$input$chrome$inputview$elements$layout$LinearLayout$$createDom$() {
  ...
  goog.dom.classlist.add(this.getElement(), i18n.input.chrome.inputview.Css.LINEAR_LAYOUT);
};
...
MARGIN_LEFT_PERCENT:"marginLeftPercent", MARGIN_RIGHT_PERCENT:"marginRightPercent", MINIMUM_HEIGHT:"minimumHeight", MORE_KEYS:"moreKeys", NUMBER_ROW_WEIGHT:"numberRowWeight", KEY_CODE:"keyCode", KEY_LIST:"keyList", MAPPING:"mapping", NAME:"name", PADDING:"padding", RECORD:"record", SHOW_MENU_KEY:"showMenuKey", SUPPORT_STICKY:"supportSticky", SPEC:"spec", TEXT:"text", TEXT_CSS_CLASS:"textCssClass", TITLE:"title", TYPE:"type", TO_STATE:"toState", TO_KEYSET:"toKeyset", TO_KEYSET_NAME:"toKeysetName", 
WIDTH:"width", WIDTH_IN_WEIGHT:"widthInWeight", WIDTH_PERCENT:"widthPercent"};
i18n.input.chrome.inputview.KeysetView = function $i18n$input$chrome$inputview$KeysetView$(keyData, layoutData, keyboardCode, languageCode, model, name, opt_eventTarget, opt_adapter) {
...
i18n.input.chrome.inputview.KeysetView.prototype.fromKeyset = "";
i18n.input.chrome.inputview.KeysetView.prototype.outerHeight_ = 0;
i18n.input.chrome.inputview.KeysetView.prototype.outerWidth_ = 0;
i18n.input.chrome.inputview.KeysetView.prototype.createDom = function $i18n$input$chrome$inputview$KeysetView$$createDom$() {
  i18n.input.chrome.inputview.KeysetView.superClass_.createDom.call(this);
  var elem = this.getElement();
...
i18n.input.chrome.inputview.KeysetView.prototype.update = function $i18n$input$chrome$inputview$KeysetView$$update$() {
  this.keyboardView_.update();
};
i18n.input.chrome.inputview.KeysetView.prototype.resize = function $i18n$input$chrome$inputview$KeysetView$$resize$(outerWidth, outerHeight, opt_force) {
...
i18n.input.chrome.inputview.KeysetView.prototype.getHeightInWeight = function $i18n$input$chrome$inputview$KeysetView$$getHeightInWeight$() {
...
i18n.input.chrome.inputview.KeysetView.prototype.applyConditions = function $i18n$input$chrome$inputview$KeysetView$$applyConditions$(conditions) {
  ...
  if (conditions[i18n.input.chrome.inputview.ConditionName.SHOW_GLOBE_OR_SYMBOL] && conditions[i18n.input.chrome.inputview.ConditionName.SHOW_MENU]) {
    var menuKeyView = this.softKeyConditionMap_[i18n.input.chrome.inputview.ConditionName.SHOW_MENU], globeKeyView = this.softKeyConditionMap_[i18n.input.chrome.inputview.ConditionName.SHOW_GLOBE_OR_SYMBOL];
    menuKeyView && globeKeyView && (softKeyViewGetWeight = this.softKeyViewMap_[menuKeyView.giveWeightTo]) && (globeKeyView.widthInWeight -= .1, menuKeyView.widthInWeight -= .4, softKeyViewGetWeight.dynamicaGrantedWeight += .5);
  }
};
i18n.input.chrome.inputview.KeysetView.prototype.createElement_ = function $i18n$input$chrome$inputview$KeysetView$$createElement_$(spec, opt_eventTarget) {
  ...
  switch(type) {
    case i18n.input.chrome.inputview.elements.ElementType.SOFT_KEY_VIEW:
      var condition = spec[i18n.input.chrome.inputview.SpecNodeName.CONDITION], giveWeightTo = spec[i18n.input.chrome.inputview.SpecNodeName.GIVE_WEIGHT_TO], softKeyView = new i18n.input.chrome.inputview.elements.layout.SoftKeyView(id, widthInWeight, heightInWeight, condition, giveWeightTo, opt_eventTarget);
    ...
    case i18n.input.chrome.inputview.elements.ElementType.LINEAR_LAYOUT:
      return new i18n.input.chrome.inputview.elements.layout.LinearLayout(id, opt_eventTarget);
    case i18n.input.chrome.inputview.elements.ElementType.VERTICAL_LAYOUT:
      return new i18n.input.chrome.inputview.elements.layout.VerticalLayout(id, opt_eventTarget);
    case i18n.input.chrome.inputview.elements.ElementType.LAYOUT_VIEW:
      return this.keyboardView_ = new i18n.input.chrome.inputview.elements.content.KeyboardView(id, opt_eventTarget);
    case i18n.input.chrome.inputview.elements.ElementType.CANVAS_VIEW:
      return this.canvasView_ = new i18n.input.chrome.inputview.elements.content.CanvasView(id, widthInWeight, heightInWeight, opt_eventTarget, this.adapter_);
    case i18n.input.chrome.inputview.elements.ElementType.HANDWRITING_LAYOUT:
      return new i18n.input.chrome.inputview.elements.layout.HandwritingLayout(id, opt_eventTarget);
  }
  return null;
};
i18n.input.chrome.inputview.KeysetView.prototype.createLayoutElement_ = function $i18n$input$chrome$inputview$KeysetView$$createLayoutElement_$(spec, opt_parentEventTarget) {
...
i18n.input.chrome.inputview.KeysetView.prototype.hasAltGrCharacterInTheKeyset_ = function $i18n$input$chrome$inputview$KeysetView$$hasAltGrCharacterInTheKeyset_$(keySpecs) {
...
i18n.input.chrome.inputview.KeysetView.prototype.createKey_ = function $i18n$input$chrome$inputview$KeysetView$$createKey_$(spec, hasAltGrCharacterInTheKeyset) {
  ...
  toKeysetName = spec[i18n.input.chrome.inputview.SpecNodeName.TO_KEYSET_NAME];
  switch(type) {
    case i18n.input.chrome.inputview.elements.ElementType.MODIFIER_KEY:
      ...
      return new i18n.input.chrome.inputview.elements.content.ModifierKey(id, name, iconCssClass, toState, this.dataModel_.stateManager, supportSticky);
    case i18n.input.chrome.inputview.elements.ElementType.SPACE_KEY:
      return this.spaceKey_ = new i18n.input.chrome.inputview.elements.content.SpaceKey(id, this.dataModel_.stateManager, this.title_, characters, void 0, iconCssClass);
    case i18n.input.chrome.inputview.elements.ElementType.BACKSPACE_KEY:
    ;
    case i18n.input.chrome.inputview.elements.ElementType.ENTER_KEY:
    ;
    ...
    ;
    case i18n.input.chrome.inputview.elements.ElementType.GLOBE_KEY:
      return new i18n.input.chrome.inputview.elements.content.FunctionalKey(id, type, name, iconCssClass);
    case i18n.input.chrome.inputview.elements.ElementType.IME_SWITCH:
      return new i18n.input.chrome.inputview.elements.content.FunctionalKey(id, type, name, iconCssClass, void 0, textCssClass);
    case i18n.input.chrome.inputview.elements.ElementType.MENU_KEY:
      return new i18n.input.chrome.inputview.elements.content.MenuKey(id, type, name, iconCssClass, toKeyset);
    case i18n.input.chrome.inputview.elements.ElementType.SWITCHER_KEY:
      ...
      return new i18n.input.chrome.inputview.elements.content.SwitcherKey(id, type, name, iconCssClass, toKeyset, toKeysetName, record);
    case i18n.input.chrome.inputview.elements.ElementType.COMPACT_KEY:
      var hintText = spec[i18n.input.chrome.inputview.SpecNodeName.HINT_TEXT], text = spec[i18n.input.chrome.inputview.SpecNodeName.TEXT], marginLeftPercent = spec[i18n.input.chrome.inputview.SpecNodeName.MARGIN_LEFT_PERCENT], marginRightPercent = spec[i18n.input.chrome.inputview.SpecNodeName.MARGIN_RIGHT_PERCENT], isGrey = spec[i18n.input.chrome.inputview.SpecNodeName.IS_GREY], moreKeys = spec[i18n.input.chrome.inputview.SpecNodeName.MORE_KEYS];
      return new i18n.input.chrome.inputview.elements.content.CompactKey(id, text, hintText, this.dataModel_.stateManager, marginLeftPercent, marginRightPercent, isGrey, moreKeys);
    case i18n.input.chrome.inputview.elements.ElementType.CHARACTER_KEY:
      ...
      return new i18n.input.chrome.inputview.elements.content.CharacterKey(id, keyCode || 0, characters, isLetterKey, hasAltGrCharacterInTheKeyset[isLetterKey], this.dataModel_.settings.alwaysRenderAltGrCharacter, this.dataModel_.stateManager, goog.i18n.bidi.isRtlLanguage(this.languageCode_));
  }
  return null;
};
i18n.input.chrome.inputview.KeysetView.prototype.setTitleVisible = function $i18n$input$chrome$inputview$KeysetView$$setTitleVisible$(visible) {
  this.spaceKey_ && this.spaceKey_.setTitleVisible(visible);
};
i18n.input.chrome.inputview.KeysetView.prototype.getWidthInWeight = function $i18n$input$chrome$inputview$KeysetView$$getWidthInWeight$() {
  return 0 < this.rows_.length ? this.rows_[0].getWidthInWeight() : 0;
};
i18n.input.chrome.inputview.KeysetView.prototype.hasStrokesOnCanvas = function $i18n$input$chrome$inputview$KeysetView$$hasStrokesOnCanvas$() {
  return this.canvasView_ ? this.canvasView_.hasStrokesOnCanvas() : !1;
};
i18n.input.chrome.inputview.KeysetView.prototype.cleanStroke = function $i18n$input$chrome$inputview$KeysetView$$cleanStroke$() {
  this.canvasView_ && this.canvasView_.reset();
};
i18n.input.chrome.inputview.KeysetView.prototype.isHandwriting = function $i18n$input$chrome$inputview$KeysetView$$isHandwriting$() {
...
i18n.input.chrome.inputview.KeyboardContainer.prototype.createDom = function $i18n$input$chrome$inputview$KeyboardContainer$$createDom$() {
  ...
  goog.dom.classlist.addAll(elem, [i18n.input.chrome.inputview.Css.CONTAINER, i18n.input.chrome.inputview.Css.FONT]);
};
...
i18n.input.chrome.inputview.KeyboardContainer.prototype.addKeysetView = function $i18n$input$chrome$inputview$KeyboardContainer$$addKeysetView$(keysetData, layoutData, keyset, languageCode, model, inputToolName, conditions) {
  var view = new i18n.input.chrome.inputview.KeysetView(keysetData, layoutData, keyset, languageCode, model, inputToolName, this, this.adapter_);
  view.render(this.wrapperDiv_);
  view.applyConditions(conditions);
  view.setVisible(!1);
  this.keysetViewMap[keyset] = view;
};
i18n.input.chrome.inputview.KeyboardContainer.prototype.switchToKeyset = function $i18n$input$chrome$inputview$KeyboardContainer$$switchToKeyset$(keyset, isPasswordBox, isA11yMode) {
  if (!this.keysetViewMap[keyset]) {
    return!1;
  }
  for (var name in this.keysetViewMap) {
    var view = this.keysetViewMap[name];
    name == keyset ? (view.setVisible(!0), view.update(), view.setTitleVisible(!isPasswordBox), isA11yMode && goog.dom.classlist.add(this.getElement(), i18n.input.chrome.inputview.Css.A11Y), this.currentKeysetView = view) : view.setVisible(!1);
  }
  return!0;
};
...
i18n.input.chrome.inputview.M17nCodes = "ar bn_phone ckb_en ckb_ar deva_phone ethi fa gu_phone km kn_phone lo ml_phone my my_myansan ne_inscript ne_phone si ta_inscript ta_itrans ta_phone ta_tamil99 ta_typewriter te_phone th th_pattajoti th_tis vi_tcvn vi_telex vi_viqr vi_vni".split(" ");
...
i18n.input.chrome.inputview.Settings.prototype.supportCompact = !1;
...
i18n.input.chrome.inputview.SizeSpec.A11Y_CANDIDATE_VIEW_HEIGHT = 32;
i18n.input.chrome.inputview.SizeSpec.NON_A11Y_CANDIDATE_VIEW_HEIGHT = 48;
i18n.input.chrome.inputview.SizeSpec.A11Y_WIDTH_PERCENT = {HORIZONTAL:.74, VERTICAL:.88};
i18n.input.chrome.inputview.SizeSpec.NON_A11Y_WIDTH_PERCENT = {HORIZONTAL:.84, HORIZONTAL_WIDE_SCREEN:.8, VERTICAL:.88};
...
i18n.input.chrome.inputview.Statistics.prototype.setCurrentLayout = function $i18n$input$chrome$inputview$Statistics$$setCurrentLayout$(layoutCode) {
  this.layoutCode_ = layoutCode;
};
i18n.input.chrome.inputview.Statistics.prototype.recordSwitch = function $i18n$input$chrome$inputview$Statistics$$recordSwitch$(layoutCode) {
...
i18n.input.chrome.inputview.Controller = function $i18n$input$chrome$inputview$Controller$(keyset, languageCode, passwordLayout, name) {
  ...
  this.adapter_ = new i18n.input.chrome.inputview.Adapter;
...
i18n.input.chrome.inputview.Controller.DISABLE_HWT = !0;
...
i18n.input.chrome.inputview.Controller.prototype.passwordKeyset_ = "";
i18n.input.chrome.inputview.Controller.prototype.registerEventHandler_ = function $i18n$input$chrome$inputview$Controller$$registerEventHandler_$() {
  this.handler_.listen(this.model_, i18n.input.chrome.inputview.events.EventType.LAYOUT_LOADED, this.onLayoutLoaded_).listen(this.model_, i18n.input.chrome.inputview.events.EventType.CONFIG_LOADED, this.onConfigLoaded_).listen(this.m17nModel_, i18n.input.chrome.inputview.events.EventType.CONFIG_LOADED, this.onConfigLoaded_).listen(this.pointerHandler_, [i18n.input.chrome.inputview.events.EventType.LONG_PRESS, i18n.input.chrome.inputview.events.EventType.DOUBLE_CLICK, i18n.input.chrome.inputview.events.EventType.POINTER_UP, 
  i18n.input.chrome.inputview.events.EventType.POINTER_DOWN, i18n.input.chrome.inputview.events.EventType.POINTER_OVER, i18n.input.chrome.inputview.events.EventType.POINTER_OUT, i18n.input.chrome.inputview.events.EventType.SWIPE], this.onPointerEvent_).listen(window, goog.events.EventType.RESIZE, this.resize).listen(this.adapter_, i18n.input.chrome.inputview.events.EventType.SURROUNDING_TEXT_CHANGED, this.onSurroundingTextChanged_).listen(this.adapter_, i18n.input.chrome.DataSource.EventType.CANDIDATES_BACK, 
  this.onCandidatesBack_).listen(this.adapter_, i18n.input.chrome.inputview.events.EventType.CONTEXT_FOCUS, this.onContextFocus_).listen(this.adapter_, i18n.input.chrome.inputview.events.EventType.CONTEXT_BLUR, this.onContextBlur_).listen(this.adapter_, i18n.input.chrome.inputview.events.EventType.VISIBILITY_CHANGE, this.onVisibilityChange_).listen(this.adapter_, i18n.input.chrome.inputview.events.EventType.SETTINGS_READY, this.onSettingsReady_).listen(this.adapter_, i18n.input.chrome.message.Type.UPDATE_SETTINGS, 
...
i18n.input.chrome.inputview.Controller.prototype.onUpdateSettings_ = function $i18n$input$chrome$inputview$Controller$$onUpdateSettings_$(e) {
  ...
  goog.isDef(e.msg.supportCompact) && (settings.supportCompact = e.msg.supportCompact);
  goog.isDef(e.msg[i18n.input.chrome.message.Name.KEYSET]) && (this.currentKeyset_ = e.msg[i18n.input.chrome.message.Name.KEYSET]);
  ...
  this.switchToKeySet(isPassword ? this.passwordKeyset_ : this.currentKeyset_);
};
i18n.input.chrome.inputview.Controller.prototype.onSettingsReady_ = function $i18n$input$chrome$inputview$Controller$$onSettingsReady_$() {
  if (!this.isSettingReady) {
    ...
    if (this.adapter_.isA11yMode) {
      this.passwordKeyset_ = this.currentKeyset_ = i18n.input.chrome.inputview.util.getConfigName(this.currentKeyset_);
    } else {
      var preferredKeyset = this.model_.settings.getPreference(i18n.input.chrome.inputview.util.getConfigName(this.currentKeyset_));
      preferredKeyset && (this.passwordKeyset_ = this.currentKeyset_ = preferredKeyset);
    }
    this.maybeCreateViews_();
    this.switchToKeySet(this.adapter_.isPasswordBox() ? this.passwordKeyset_ : this.currentKeyset_);
  }
};
...
i18n.input.chrome.inputview.Controller.prototype.onPointerEvent_ = function $i18n$input$chrome$inputview$Controller$$onPointerEvent_$(e) {
  if (!this.adapter_.isChromeVoxOn && this.model_.settings.enableLongPress || e.type != i18n.input.chrome.inputview.events.EventType.LONG_PRESS) {
    e.view ? this.handlePointerAction_(e.view, e) : this.currentKeyset_ == i18n.input.chrome.inputview.Controller.HANDWRITING_VIEW_CODE_ && this.switchToKeySet(this.container_.currentKeysetView.fromKeyset);
  }
};
...
i18n.input.chrome.inputview.Controller.prototype.executeCommand_ = function $i18n$input$chrome$inputview$Controller$$executeCommand_$(command, opt_arg) {
  ...
  switch(command) {
    ...
    case CommandEnum.SWITCH_KEYSET:
      var keyset = opt_arg;
      keyset && (this.statistics_.recordSwitch(keyset), this.switchToKeySet(keyset));
      break;
...
i18n.input.chrome.inputview.Controller.prototype.handlePointerAction_ = function $i18n$input$chrome$inputview$Controller$$handlePointerAction_$(view, e) {
  ...
  switch(view.type) {
    case i18n.input.chrome.inputview.elements.ElementType.BACK_BUTTON:
      e.type == i18n.input.chrome.inputview.events.EventType.POINTER_UP && this.switchToKeySet(this.container_.currentKeysetView.fromKeyset);
      return;
    ...
    case i18n.input.chrome.inputview.elements.ElementType.MENU_ITEM:
      e.type == i18n.input.chrome.inputview.events.EventType.POINTER_UP && (this.resetAll_(), this.executeCommand_.apply(this, view.getCommand()), this.container_.menuView.hide());
  ...
  view.type == i18n.input.chrome.inputview.elements.ElementType.MODIFIER_KEY || this.container_.altDataView.isVisible() || this.container_.menuView.isVisible() || (e.type == i18n.input.chrome.inputview.events.EventType.POINTER_OVER || e.type == i18n.input.chrome.inputview.events.EventType.POINTER_DOWN ? view.setHighlighted(!0) : e.type != i18n.input.chrome.inputview.events.EventType.POINTER_OUT && e.type != i18n.input.chrome.inputview.events.EventType.POINTER_UP || view.setHighlighted(!1));
  ...
  switch(softKey.type) {
    ...
    case i18n.input.chrome.inputview.elements.ElementType.CHARACTER_KEY:
      ...
      if (e.type == i18n.input.chrome.inputview.events.EventType.LONG_PRESS) {
        this.container_.altDataView.show(key, goog.i18n.bidi.isRtlLanguage(this.languageCode_));
      } else {
        if (e.type == i18n.input.chrome.inputview.events.EventType.POINTER_UP) {
    ...
    case i18n.input.chrome.inputview.elements.ElementType.MODIFIER_KEY:
      ...
      e.type == i18n.input.chrome.inputview.events.EventType.POINTER_DOWN ? (this.changeState_(key.toState, !isStateEnabled, !0), this.model_.stateManager.setKeyDown(key.toState, !0)) : e.type == i18n.input.chrome.inputview.events.EventType.POINTER_UP || e.type == i18n.input.chrome.inputview.events.EventType.POINTER_OUT ? (isChording ? this.changeState_(key.toState, !1, !1) : key.toState != i18n.input.chrome.inputview.StateType.CAPSLOCK && this.model_.stateManager.isKeyDown(key.toState) && this.changeState_(key.toState, 
      isStateEnabled, !1), this.model_.stateManager.setKeyDown(key.toState, !1)) : e.type == i18n.input.chrome.inputview.events.EventType.DOUBLE_CLICK ? this.changeState_(key.toState, isStateEnabled, !0) : e.type != i18n.input.chrome.inputview.events.EventType.LONG_PRESS || isChording || (this.changeState_(key.toState, !0, !0), this.model_.stateManager.setKeyDown(key.toState, !1));
      break;
    case i18n.input.chrome.inputview.elements.ElementType.BACKSPACE_KEY:
      key = softKey;
    ...
    case i18n.input.chrome.inputview.elements.ElementType.ENTER_KEY:
      key = softKey;
      e.type == i18n.input.chrome.inputview.events.EventType.POINTER_DOWN ? this.adapter_.sendKeyDownEvent("\r", i18n.input.chrome.inputview.events.KeyCodes.ENTER) : e.type == i18n.input.chrome.inputview.events.EventType.POINTER_UP && this.adapter_.sendKeyUpEvent("\r", i18n.input.chrome.inputview.events.KeyCodes.ENTER);
      break;
    case i18n.input.chrome.inputview.elements.ElementType.ARROW_UP:
    ...
    case i18n.input.chrome.inputview.elements.ElementType.SPACE_KEY:
      key = softKey;
      e.type == i18n.input.chrome.inputview.events.EventType.POINTER_UP && (this.adapter_.sendKeyDownAndUpEvent(key.getCharacter(), i18n.input.chrome.inputview.events.KeyCodes.SPACE), this.clearUnstickyState_());
      break;
    case i18n.input.chrome.inputview.elements.ElementType.SWITCHER_KEY:
      key = softKey;
      e.type == i18n.input.chrome.inputview.events.EventType.POINTER_UP && (this.statistics_.recordSwitch(key.toKeyset), this.resetAll_(), this.switchToKeySet(key.toKeyset), key.record && this.model_.settings.savePreference(i18n.input.chrome.inputview.util.getConfigName(key.toKeyset), key.toKeyset));
      break;
    case i18n.input.chrome.inputview.elements.ElementType.COMPACT_KEY:
      key = softKey;
    ...
    case i18n.input.chrome.inputview.elements.ElementType.MENU_KEY:
      key = softKey;
      if (e.type == i18n.input.chrome.inputview.events.EventType.POINTER_DOWN) {
        var isCompact = -1 != this.currentKeyset_.indexOf("compact"), keysetData = this.keysetDataMap_[this.currentKeyset_], enableCompact = !this.adapter_.isA11yMode && keysetData[i18n.input.chrome.inputview.SpecNodeName.HAS_COMPACT_KEYBOARD] && this.model_.settings.supportCompact, self = this, currentKeyset = this.currentKeyset_, hasHwt = !i18n.input.chrome.inputview.Controller.DISABLE_HWT && goog.object.contains(i18n.input.lang.InputToolCode, this.getHwtInputToolCode_()), enableSettings = window.inputview && 
        inputview.openSettings;
        this.adapter_.getInputMethods(function(inputMethods) {
          self.container_.menuView.show(key, currentKeyset, isCompact, enableCompact, inputMethods, hasHwt, enableSettings);
        });
      }
      break;
    case i18n.input.chrome.inputview.elements.ElementType.GLOBE_KEY:
...
i18n.input.chrome.inputview.Controller.prototype.stopBackspaceAutoRepeat_ = function $i18n$input$chrome$inputview$Controller$$stopBackspaceAutoRepeat_$() {
  ...
  this.adapter_.sendKeyUpEvent("\b", i18n.input.chrome.inputview.events.KeyCodes.BACKSPACE);
...
i18n.input.chrome.inputview.Controller.prototype.backspaceTick_ = function $i18n$input$chrome$inputview$Controller$$backspaceTick_$() {
  this.backspaceRepeated_ >= i18n.input.chrome.inputview.Controller.BACKSPACE_REPEAT_LIMIT_ ? this.stopBackspaceAutoRepeat_() : (this.backspaceRepeated_++, this.backspaceDown_(), this.backspaceAutoRepeat_ ? this.backspaceAutoRepeat_.start(75) : (this.backspaceAutoRepeat_ = new goog.async.Delay(goog.bind(this.backspaceTick_, this), 300), this.backspaceAutoRepeat_.start()));
};
i18n.input.chrome.inputview.Controller.prototype.onVisibilityChange_ = function $i18n$input$chrome$inputview$Controller$$onVisibilityChange_$() {
  this.adapter_.isVisible || this.resetAll_();
};
...
i18n.input.chrome.inputview.Controller.prototype.changeState_ = function $i18n$input$chrome$inputview$Controller$$changeState_$(stateType, enable, isSticky) {
  ...
  isEnabledBefore == enable && isStickyBefore == isSticky || this.container_.update();
};
...
i18n.input.chrome.inputview.Controller.prototype.onCandidatesBack_ = function $i18n$input$chrome$inputview$Controller$$onCandidatesBack_$(e) {
  this.candidatesInfo_ = new i18n.input.chrome.inputview.CandidatesInfo(e.source, e.candidates, e.matchedLengths);
...
i18n.input.chrome.inputview.Controller.prototype.showCandidates_ = function $i18n$input$chrome$inputview$Controller$$showCandidates_$(source, candidates, operation) {
  ...
  if (0 == candidates.length) {
    ...
    var isThreeCandidates = -1 != this.currentKeyset_.indexOf("compact");
    if (isThreeCandidates && source && 1 < candidates.length) {
  ...
  if (this.isSettingReady) {
    for (var keyset in this.keysetDataMap_) {
      ...
      if (!this.container_.keysetViewMap[keyset] && layoutData) {
        ...
        this.container_.addKeysetView(keysetData, layoutData, keyset, this.languageCode_, this.model_, this.inputToolName_, conditions);
        this.switchToKeySet(this.currentKeyset_);
      }
    }
  }
};
i18n.input.chrome.inputview.Controller.prototype.switchToKeySet = function $i18n$input$chrome$inputview$Controller$$switchToKeySet$(keyset) {
  if (this.isSettingReady) {
    var ret = this.container_.switchToKeyset(keyset, this.adapter_.isPasswordBox(), this.adapter_.isA11yMode);
    if (ret) {
      this.currentKeyset_ != keyset && (this.container_.currentKeysetView.fromKeyset = this.currentKeyset_);
      var isHwt = keyset == i18n.input.chrome.inputview.Controller.HANDWRITING_VIEW_CODE_;
      isHwt ? (this.container_.candidateView.switchToIcon(i18n.input.chrome.inputview.elements.content.CandidateView.IconType.BACK, !0), this.adapter_.setInputToolCode(this.getHwtInputToolCode_()), goog.dom.classlist.add(this.container_.getElement(), i18n.input.chrome.inputview.Css.HANDWRITING), this.container_.hasStrokesOnCanvas() && this.container_.cleanStroke()) : this.currentKeyset_ == i18n.input.chrome.inputview.Controller.HANDWRITING_VIEW_CODE_ && (this.adapter_.unsetInputToolCode(), goog.dom.classlist.remove(this.container_.getElement(), 
      i18n.input.chrome.inputview.Css.HANDWRITING));
      this.clearCandidates_();
      this.resize(i18n.input.chrome.inputview.Controller.DEV);
      this.container_.candidateView.switchToIcon(i18n.input.chrome.inputview.elements.content.CandidateView.IconType.BACK, isHwt);
      this.adapter_.isPasswordBox() && "us.compact.qwerty" == keyset ? this.container_.candidateView.showNumberRow() : this.container_.candidateView.hideNumberRow();
...
i18n.input.chrome.inputview.Controller.prototype.resize = function $i18n$input$chrome$inputview$Controller$$resize$(opt_ignoreWindowResize) {
  var height, widthPercent, candidateViewHeight;
  if (this.adapter_.isA11yMode) {
    ...
    var isHorizontal = screen.width > screen.height, isWideScreen = .6 > screen.width / screen.height;
    widthPercent = isHorizontal ? isWideScreen ? i18n.input.chrome.inputview.SizeSpec.NON_A11Y_WIDTH_PERCENT.HORIZONTAL_WIDE_SCREEN : i18n.input.chrome.inputview.SizeSpec.NON_A11Y_WIDTH_PERCENT.HORIZONTAL : i18n.input.chrome.inputview.SizeSpec.NON_A11Y_WIDTH_PERCENT.VERTICAL;
    candidateViewHeight = i18n.input.chrome.inputview.SizeSpec.NON_A11Y_CANDIDATE_VIEW_HEIGHT;
  }
  var viewportSize = goog.dom.getViewportSize();
  viewportSize.height == height || opt_ignoreWindowResize ? (this.container_.resize(screen.width, height, widthPercent, candidateViewHeight), this.container_.currentKeysetView && (this.isKeyboardReady = !0)) : window.resizeTo(screen.width, height);
};
i18n.input.chrome.inputview.Controller.prototype.initialize = function $i18n$input$chrome$inputview$Controller$$initialize$(keyset, languageCode, passwordLayout, name) {
  this.languageCode_ = languageCode;
  this.passwordKeyset_ = passwordLayout;
  languageCode && this.adapter_.setLanguage(languageCode.split("-")[0]);
  this.currentKeyset_ = keyset;
  this.inputToolName_ = name;
  this.model_.loadConfig(i18n.input.chrome.inputview.Controller.HANDWRITING_VIEW_CODE_);
...
i18n.input.chrome.inputview.Controller.prototype.disposeInternal = function $i18n$input$chrome$inputview$Controller$$disposeInternal$() {
  chrome.runtime.sendMessage(goog.object.create(i18n.input.chrome.message.Name.MSG_TYPE, i18n.input.chrome.message.Type.DISCONNECT));
...
window.onload = function $window$onload$() {
  var uri = new goog.Uri(window.location.href), code = uri.getParameterValue("id") || "us", language = uri.getParameterValue("language") || "en", passwordLayout = uri.getParameterValue("passwordLayout") || "us", name = chrome.i18n.getMessage(uri.getParameterValue("name") || "English"), controller = new i18n.input.chrome.inputview.Controller(code, language, passwordLayout, name);
